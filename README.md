...
Point being, Pokémon Yellow was built off Green, and used Green's palette as a base for its own. You can see the shared purple hue in Pallet town, but what also stands out is the drastic change in brightness and saturation between the colors used for Yellow's Super GameBoy mode and GameBoy Color mode. I believe in their attempt to tint the game in yellow hue, they decided to really crank up the exposure on the Super GameBoy palette. On the other hand, they likely needed to overly saturate the colors for the GameBoy Color just to be noticeable outdoors on the GameBoy's non-backlit display.
