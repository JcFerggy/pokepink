...
; Lavender Town events
	...
	const EVENT_POKEMONMANSION1F_CHIEF_RESET
	const EVENT_CELADONMARTROOF_CHIEF_RESET
	const EVENT_SAFARIZONEWEST_CHIEF_RESET
	const EVENT_UNDERGROUNDPATHNORTHSOUTH_CHIEF_RESET
	const EVENT_UNDERGROUNDPATHWESTEAST_CHIEF_RESET
	const EVENT_VICTORYROAD3F_CHIEF_RESET
	const_skip 10
...
; Celadon City events
	...
	const EVENT_BEAT_CERULEANTRASHEDHOUSE_TRAINER_0 ;PINK
	const EVENT_BEAT_CERULEANTRASHEDHOUSE_TRAINER_1
	const EVENT_BEAT_CERULEANTRASHEDHOUSE_TRAINER_2
	const EVENT_BEAT_CERULEANTRASHEDHOUSE_TRAINER_3
	const EVENT_BEAT_CERULEANTRASHEDHOUSE_TRAINER_4
	const EVENT_BEAT_CERULEANTRASHEDHOUSE_TRAINER_5
	const EVENT_BEAT_CERULEANTRASHEDHOUSE_TRAINER_6
	const EVENT_1B8 ; ???
	...
	const EVENT_1BF ; ???
	const_skip 31
	const EVENT_BEAT_CELADONMARTROOF_CHIEF
...
; Fuchsia City events
	...
	const EVENT_BEAT_SAFARIZONEWEST_CHIEF
	const EVENT_BEAT_SUMMERBEACHHOUSE_TRAINER_0
	const EVENT_REVEAL_SUMMERBEACHHOUSE_TRAINER
	const_skip 5
...
; Route 10 events
	...
	const EVENT_BEAT_UNDERGROUND_CHIEF ;PINK
	const EVENT_BEAT_UNDERGROUND2_CHIEF ;PINK
...
; Victory Road 3F events
	...
	const EVENT_BEAT_VICTORY_ROAD_CHIEF ;PINK
...
; Pokémon Mansion events
	const_next $800
	const EVENT_BEAT_MANSION_CHIEF
