...
; after battle and are detected in wToggleableObjectList.)
	...
	toggle_consts_for CELADON_MART_ROOF
	const TOGGLE_CELADONMARTROOF_CHIEF         ; 3E X
	...
	toggle_consts_for UNDERGROUND_PATH_WEST_EAST
	const TOGGLE_UNDERGROUNDPATHWESTEAST_CHIEF            ; 47 X PINK

	toggle_consts_for POKEMON_MANSION_1F
	const TOGGLE_POKEMON_MANSION_CHIEF     ; 48 X PINK
	...
	toggle_consts_for CERULEAN_TRASHED_HOUSE
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_7  ; 66 X ;PINK
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_1  ; 67 X
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_2  ; 68 X
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_3  ; 69 X
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_4  ; 6A X
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_5  ; 6B X
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_6  ; 6C X
	...
	const TOGGLE_VICTORY_ROAD_3F_ITEM_1        ; 7A X ;Blue fight VR F3
	...
	const TOGGLE_SUMMER_BEACH_HOUSE_IMPOSTER     ; 7F X
	const TOGGLE_SUMMER_BEACH_HOUSE_FAIRY     ; 80 X
	const TOGGLE_SUMMER_BEACH_HOUSE_PIKACHU     ; 81 X
	const TOGGLE_SUMMER_BEACH_HOUSE_YELLOW     ; 82 X
	...
	toggle_consts_for UNDERGROUND_PATH_NORTH_SOUTH
	const TOGGLE_UNDERGROUND_CHIEF               ; BF XXX sprite doesn't exist PINK
	...
	const TOGGLE_SAFARIZONEWEST_CHIEF       ; CE X
