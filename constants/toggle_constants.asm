...
; after battle and are detected in wToggleableObjectList.)
	...
	const TOGGLE_POKEMON_MANSION_CHIEF         ; 4A X PINK
	...
	const TOGGLE_VICTORY_ROAD_3F_CHIEF        ; 7E X ;PINK Blue fight VR F3
	...
	toggle_consts_for UNDERGROUND_PATH_NORTH_SOUTH ;PINK
	const TOGGLE_UNDERGROUND_CHIEF               ; BF previously unused
	...
	const TOGGLE_SAFARIZONEWEST_CHIEF          ; D4 X PINK
	...
	toggle_consts_for CELADON_MART_ROOF ;PINK Everything is shhifted from the earlier inserts. Off by 3.
	const TOGGLE_CELADONMARTROOF_CHIEF         ; EF
	
	toggle_consts_for UNDERGROUND_PATH_WEST_EAST ;PINK
	const TOGGLE_UNDERGROUNDPATHWESTEAST_CHIEF ; F0
	
	toggle_consts_for CERULEAN_TRASHED_HOUSE ;PINK
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_1  ; F1
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_2  ; F2
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_3  ; F3
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_4  ; F4
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_5  ; F5
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_6  ; F6
	const TOGGLE_CERULEANTRASHEDHOUSE_CHIEF_7  ; F7
	
	toggle_consts_for SUMMER_BEACH_HOUSE
	const TOGGLE_SUMMER_BEACH_HOUSE_IMPOSTER   ; F8
	const TOGGLE_SUMMER_BEACH_HOUSE_FAIRY      ; F9
	const TOGGLE_SUMMER_BEACH_HOUSE_YELLOW     ; FA

	const TOGGLE_DAISY_SITTING_COPY            ; FB
	const TOGGLE_DAISY_WALKING_COPY            ; FC
	const TOGGLE_TOWN_MAP_COPY                 ; FD
