...
MonPartySpritePointers:
	...
	mon_icon_header PikachuSprite,         12, 4, ICON_FAIRY << 2
	...
	mon_icon_header FairySprite,        0, 4, ICON_PIKACHU << 2
	...
	mon_icon_header PikachuSprite,          0, 4, ICONOFFSET + ICON_FAIRY << 2
	...
	mon_icon_header FairySprite,       12, 4, ICONOFFSET + ICON_PIKACHU << 2
