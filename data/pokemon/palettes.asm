MonsterPalettes:
	...
	db PAL_GRAYMON_YELLOW   ; RATICATE ;PINK
	...
	db PAL_GRAYMON_YELLOW   ; GEODUDE ;PINK
	db PAL_GRAYMON_YELLOW   ; GRAVELER
	db PAL_GRAYMON_YELLOW   ; GOLEM
	...
	db PAL_GRAYMON_YELLOW   ; CUBONE ;PINK
	db PAL_GRAYMON_YELLOW   ; MAROWAK
