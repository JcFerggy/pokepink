...
SpriteSheetPointerTable:
	...
	overworld_sprite BlueMangaSprite, 12              ; SPRITE_CHEIF ;PINK
	...
	overworld_sprite YellowMangaSprite, 12      ; PINK was SPRITE_UNUSED_RED_2
	...
	overworld_sprite BrockSprite, 12            ; SPRITE_BRICK
