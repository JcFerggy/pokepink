...
FairySprite::            INCBIN "gfx/sprites/fairy.2bpp" ;PINK Swap sprites.
...
PikachuSprite::          INCBIN "gfx/sprites/clefairy.2bpp" ;PINK Swap sprites.
...
ClefairySprite::         INCBIN "gfx/sprites/pikachu.2bpp"
